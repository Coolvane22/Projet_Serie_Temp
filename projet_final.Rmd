...
On remarque globalement une tendance à la hausse au fil des années, sûrement lié à l'inflation.  
...
```
Nous testons plusieurs degrés de l'opérateur différence afin de repérer l'ordre de la tendance polynomiale (ou linéaire).
...
### Saisonnalité
```{r}
## On teste différentes valeurs pour la période de la saisonnalité. On teste avec 3, 6, 9 et 12
par(mfrow = c(2,2))
...
Grâce au test de stationnarité , nous pouvous nous interésser à estimer notre composante aléatoire.
