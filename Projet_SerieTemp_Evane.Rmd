...
Avec la visualisation du graphique ,on identifie une répétition pour le mois avec le montant le plus élevé des dépénses : le mois d'avril, puis le montant le moins elevé qui se situe en général lors du mois de septembre. Nous supposons donc une saisonnalite de 6 mois. Au fil des années, on identifie clairement une tendance à la hausse.
